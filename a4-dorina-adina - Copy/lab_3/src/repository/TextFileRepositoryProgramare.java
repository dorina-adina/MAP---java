    ...
    private void writeInFile() throws IOException {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(fileName))) {
            for (Programare entitate : entitati) {
                String linie = entitate.getId() + "," + entitate.getPacient().getId() + "," + entitate.getPacient().getNume() + "," + entitate.getPacient().getPrenume() + "," + entitate.getPacient().getVarsta()  + "," + entitate.getData() + "," + entitate.getOra() + "," + entitate.getScopulProgramarii() + ",";
                bw.write(linie);
                bw.newLine();
            }
        } catch (IOException e) {
