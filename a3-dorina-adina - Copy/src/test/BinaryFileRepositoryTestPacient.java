...
import src.repository.BinaryFileRepositoryPacient;
...
public class BinaryFileRepositoryTestPacient {
   private static final String FILE_NAME = "C:/Users/User/Documents/GitHub/a3-dorina-adina/src/testDataPacient.bin";
   ...
   public void testAddAndSave() throws RepositoryException, IOException, ClassNotFoundException {
       Pacient pacient = new Pacient(1, "Ionesc", "Pavel", 22);
       Pacient pacient2 = new Pacient(2, "Ionel", "Pavel", 20);
