...
public class UI {
    ...
    public void UIaddPacient() throws DuplicateException { ///adaugam pacient
        int ID, varsta;
        String str;
        String nume, prenume;
    ...
    public void UIaddProgramare() throws RepositoryException { ///adaugam programare
        ...
        programare = new Programare(ID, pacientService.findPacient(IDpacient), data, ora, scopulProgramarii);
    ...
    public void UIupdateProgramare() throws RepositoryException { ///modifcam o programare
        ...
        Programare programare = new Programare(ID, pacientService.findPacient(IDpacientNou), dataNoua, oraNoua, scopulProgramariiNou);
